...
const connect = async (file_path) => {
 ...
 case DisconnectReason.timedOut: {
  const msg = `⚠️ [${file_path}] Connection lost. Bot Reconnecting... please wait`;
  console.log(msg);
  await notifyDeveloper(msg, file_path);
...
//=================================================================================
    // Enhanced event handler for welcome messages
    conn.ev.on('group-participants.update', async (update) => {
      ...
      // Check if welcome should be sent
    ...
    // Enhanced event handler for goodbye messages
